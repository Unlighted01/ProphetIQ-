      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
        {AGENTS.map((agent, i) => (
          ...
          >
            ...
            {/* CTA */}
            <button className="w-full py-2.5 rounded-xl text-xs font-bold text-white border border-white/10 hover:border-yellow-500/50 hover:bg-yellow-500/10 hover:shadow-[0_0_15px_rgba(234,179,8,0.3)] transition-all flex items-center justify-center gap-2">
              <svg className="w-3.5 h-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
              </svg>
              Request Site Inspection Report
            </button>
          </div>
        ))}
      </div>
